...
import LevelUpCelebration from '../../home/components/Effect'; // ✅ 統一された演出コンポーネント
...
export function BattlePage() {
  ...
  const handleResultNext = async (winner: 'me' | 'opponent') => {
    if (winner === 'me') {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      ...
      {showLevelUp && (
        <LevelUpCelebration onClose={() => setShowLevelUp(false)} />
      )}
    </SafeAreaView>
  );
}
